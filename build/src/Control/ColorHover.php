...
class ColorHover extends ControlBase
{
    ...
    public function contentTemplate(): void
    {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
                ...
                <input data-setting="{{ name }}_hover" class="color-picker-hex" type="text" maxlength="7" placeholder="<?php Helper::escAttr('Hex Value'); ?>" {{ defaultValue }}{{ dataAlpha }} />
			</div>
		</div>
		<?php
    }
