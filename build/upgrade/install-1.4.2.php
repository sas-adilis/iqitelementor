...
/**
 * Create widget_style table for the Widget Styles Library.
 * Also drops the old widget_default table if it exists.
 */
function upgrade_module_1_4_2($object)
{
    $db = Db::getInstance();

    // Drop old table from previous iteration (may not exist)
    $db->execute(
