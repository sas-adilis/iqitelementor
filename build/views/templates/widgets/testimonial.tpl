{assign var='widget_type' value='testimonial'}
    ...
    {foreach from=$testimonials_list item=testimonial}
        <div class="swiper-slide">
            <div class="elementor-testimonial-wrapper{$testimonial_alignment}">
                ...
                {/if}
                {if $testimonial.name || ($show_notes && $testimonial.note) || ($show_date && !empty($testimonial.review_date_display))}
                <div class="elementor-testimonial-meta">
                    ...
                    {/if}
                    {if $show_date && !empty($testimonial.review_date_display)}
                    <div class="elementor-testimonial-date">
                        <time datetime="{$testimonial.review_date_iso|escape:'html':'UTF-8'}">{$testimonial.review_date_display|escape:'html':'UTF-8'}</time>
                    </div>
                    {/if}
                </div>
                {/if}
