...
class IqitElementorContent extends ObjectModel
{
    ...
    public static function getSelectableHooks(): array
    {
    ...
    public static function getIdByObjectAndHook($hook, $idObject, $id_shop = null)
    {
        ...
        if ($id_shop) {
            $sql = 'SELECT c.id_elementor FROM ' . _DB_PREFIX_ . 'iqit_elementor_content c LEFT JOIN ' . _DB_PREFIX_ . 'iqit_elementor_content_shop s ON c.id_elementor = s.id_elementor WHERE c.id_object = ' . (int) $idObject . ' AND c.hook = ' . (int) $hook . ' AND s.id_shop = ' . (int) $id_shop;
        } else {
            $sql = 'SELECT c.id_elementor FROM ' . _DB_PREFIX_ . 'iqit_elementor_content c WHERE c.id_object = ' . (int) $idObject . ' AND c.hook = ' . (int) $hook;
        }
    ...
    public static function deleteElement($idElementor): void
    {
