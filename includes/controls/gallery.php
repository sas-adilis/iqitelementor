		...
		<div class="elementor-control-field">
			<div class="elementor-control-input-wrapper">
				...
				<div class="elementor-control-media">
					<div class="elementor-control-gallery-status">
						<span class="elementor-control-gallery-status-title">
							<# if ( data.controlValue.length ) {
								...
								<?php echo \IqitElementorTranslater::get()->l('No Images Selected', 'elementor'); ?>
							<# } #>
						</span>
						<span class="elementor-control-gallery-clear">(<?php echo \IqitElementorTranslater::get()->l('Clear', 'elementor'); ?>)</span>
					</div>
					...
					<button class="elementor-button elementor-control-gallery-add"><?php echo \IqitElementorTranslater::get()->l('+ Add Images', 'elementor'); ?></button>
				</div>
			</div>
		</div>
		<?php
