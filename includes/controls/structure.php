    ...
    public function content_template()
    {
		...
		<div class="elementor-control-field">
			<div class="elementor-control-input-wrapper">
				<div class="elementor-control-structure-title"><?php echo \IqitElementorTranslater::get()->l('Structure', 'elementor'); ?></div>
				...
				<div class="elementor-control-structure-reset"><i class="fa fa-undo"></i><?php echo \IqitElementorTranslater::get()->l('Reset Structure', 'elementor'); ?></div>
				<#
				var morePresets = getMorePresets();

				if ( morePresets.length > 1 ) { #>
					<div class="elementor-control-structure-more-presets-title"><?php echo \IqitElementorTranslater::get()->l('More Structures', 'elementor'); ?></div>
