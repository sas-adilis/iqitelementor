...
<script type="text/template" id="tmpl-elementor-navigator">
    <div id="elementor-navigator__header">
        ...
        <div id="elementor-navigator__header__title"><?php echo \IqitElementorTranslater::get()->l('Navigator'); ?></div>
...
<script type="text/template" id="tmpl-elementor-navigator__elements--empty">
    <div class="elementor-empty-view__title"><?php echo \IqitElementorTranslater::get()->l('Empty'); ?></div>
</script>

<script type="text/template" id="tmpl-elementor-navigator__root--empty">
    <div class="elementor-nerd-box-title"><?php echo \IqitElementorTranslater::get()->l('Easy Navigation is Here!'); ?></div>
    <div class="elementor-nerd-box-message">
        <?php echo \IqitElementorTranslater::get()->l('Once you fill your page with content, this window will give you an overview display of all the page elements. This way, you can easily move around any section, column, or widget.'); ?>
    </div>
</script>
