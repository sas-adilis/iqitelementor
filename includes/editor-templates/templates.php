...
<script type="text/template" id="tmpl-elementor-template-library-header">
	...
	<div id="elementor-template-library-header-items-area">
		<div id="elementor-template-library-header-close-modal" class="elementor-template-library-header-item" title="<?php \IqitElementorTranslater::get()->l('Close', 'elementor'); ?>">
			<i class="eicon-close" title="<?php \IqitElementorTranslater::get()->l('Close', 'elementor'); ?>"></i>
		</div>
...
<script type="text/template" id="tmpl-elementor-template-library-header-logo">
	<i class="eicon-elementor-square"></i><span><?php \IqitElementorTranslater::get()->l('Library', 'elementor'); ?></span>
</script>

<script type="text/template" id="tmpl-elementor-template-library-header-save">
	<i class="eicon-save" title="<?php \IqitElementorTranslater::get()->l('Save Template', 'elementor'); ?>"></i>
</script>

<script type="text/template" id="tmpl-elementor-template-library-header-load">
	<i class="icon-upload" title="<?php \IqitElementorTranslater::get()->l('Load Template', 'elementor'); ?>"></i>
</script>

<script type="text/template" id="tmpl-elementor-template-library-header-menu">
	<div id="elementor-template-library-menu-my-templates" class="elementor-template-library-menu-item" data-template-source="local"><?php \IqitElementorTranslater::get()->l('Templates list', 'elementor'); ?></div>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-header-preview">
	<div id="elementor-template-library-header-preview-insert-wrapper" class="elementor-template-library-header-item">
		<button id="elementor-template-library-header-preview-insert" class="elementor-template-library-template-insert elementor-button elementor-button-success">
			<i class="eicon-file-download"></i><span class="elementor-button-title"><?php \IqitElementorTranslater::get()->l('Insert', 'elementor'); ?></span>
		</button>
	</div>
</script>

<script type="text/template" id="tmpl-elementor-template-library-header-back">
	<i class="eicon-"></i><span><?php \IqitElementorTranslater::get()->l('Back To library', 'elementor'); ?></span>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-save-template">
	...
	<div class="elementor-template-library-blank-excerpt"><?php \IqitElementorTranslater::get()->l('Your designs will be available for export and reuse on any page or website', 'elementor'); ?></div>
	<form id="elementor-template-library-save-template-form">
		<input id="elementor-template-library-save-template-name" name="title" placeholder="<?php \IqitElementorTranslater::get()->l('Enter Template Name', 'elementor'); ?>" required>
	...
	<div class="elementor-template-library-blank-footer">
		<?php \IqitElementorTranslater::get()->l('What is Library?', 'elementor'); ?>
		<a class="elementor-template-library-blank-footer-link" href="https://go.elementor.com/docs-library/" target="_blank"><?php \IqitElementorTranslater::get()->l('Read our tutorial on using Library templates.', 'elementor'); ?></a>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-load-template">
	...
	<div class="elementor-template-library-blank-excerpt"><?php \IqitElementorTranslater::get()->l('Import your .json design file from your local pc', 'elementor'); ?></div>
	<form id="elementor-template-library-load-template-form">
		<div id="elementor-template-library-load-wrapper">
		<button id="elementor-template-library-load-btn-file"><?php \IqitElementorTranslater::get()->l('Select template .json file', 'elementor'); ?></button>
		...
		<button id="elementor-template-library-load-template-submit" class="elementor-button elementor-button-success">
			...
			<?php \IqitElementorTranslater::get()->l('load', 'elementor'); ?>
		</button>
	</form>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-templates-empty">
	...
	<div class="elementor-template-library-blank-title"><?php \IqitElementorTranslater::get()->l('Haven’t Saved Templates Yet?', 'elementor'); ?></div>
	<div class="elementor-template-library-blank-excerpt"><?php \IqitElementorTranslater::get()->l('This is where your templates should be. Design it. Save it. Reuse it.', 'elementor'); ?></div>
	<div class="elementor-template-library-blank-footer">
		<?php \IqitElementorTranslater::get()->l('What is Library?', 'elementor'); ?>
		<a class="elementor-template-library-blank-footer-link" href="https://go.elementor.com/docs-library/" target="_blank"><?php \IqitElementorTranslater::get()->l('Read our tutorial on using Library templates.', 'elementor'); ?></a>
	</div>
