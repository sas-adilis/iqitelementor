(function () {
    ...
    7: [function (require, module, exports) {
        ...
        /**
         * -------------------------------------------------------------------------
         *  ELEMENTOR TEMPLATE LIBRARY (BUNDLED)
         *
         *  NOTE:
         *  This whole section (modules 8–26 etc.) is the compiled Browserify bundle
         *  for the template library (models / views / manager).
         *
         *  It uses the pattern:
         *      },{}],<id>:[function(require,module,exports){ ... module.exports = ... }
         *
         *  This structure is required by the Browserify runtime and cannot be
         *  safely removed without completely rebuilding the bundle from sources.
         *
         *  If you want to work with readable code, focus on the internal content
         *  of each module (the Marionette views / Backbone models / manager
         *  functions), and ignore the "} ,{}],<id>:[function..." wrappers – they are
         *  just the module system glue.
         *
         *  When customising features (e.g. navigator, tabs, templates), it is safer
         *  to:
         *    - add new, explicit functions / objects in this same file, and
         *    - wire the app (App = Marionette.Application.extend) to use them,
         *  rather than trying to strip or rewrite the Browserify wrappers.
         * -------------------------------------------------------------------------
         */
    }, {}],
    ...
    }, {"elementor-templates/models/template": 10}],
    ...
    }, {"elementor-templates/collections/templates": 8, "elementor-templates/views/layout": 11}],
    ...
    11: [function (require, module, exports) {
        ...
        "elementor-templates/views/parts/header-parts/back": 12,
        "elementor-templates/views/parts/header-parts/load": 13,
        "elementor-templates/views/parts/header-parts/logo": 14,
        "elementor-templates/views/parts/header-parts/menu": 15,
        "elementor-templates/views/parts/header-parts/preview": 16,
        "elementor-templates/views/parts/header-parts/save": 17,
        "elementor-templates/views/parts/load-template": 19,
    ...
    }, {"elementor-templates/views/parts/templates-empty": 23, "elementor-templates/views/template/local": 26}],
    ...
    27: [function (require, module, exports) {
            ...
            getControlItemView: function (controlType) {
                if (null === this._controlsItemView) {
                    this._controlsItemView = {
                        ...
                        color_hover: require('elementor-views/controls/color')
                    };
        ...
        "elementor-layouts/panel/panel": 51,
        "elementor-models/element": 54,
        "elementor-templates/manager": 9,
        "elementor-utils/ajax": 58,
        "elementor-utils/helpers": 59,
        "elementor-utils/introduction": 60,
        "elementor-utils/modals": 63,
        "elementor-utils/presets-factory": 64,
        "elementor-utils/schemes": 65,
        "elementor-views/controls/animation": 69,
        "elementor-views/controls/autocomplete-posts": 70,
        "elementor-views/controls/autocomplete-products": 71,
        "elementor-views/controls/base": 74,
        "elementor-views/controls/box-shadow": 75,
        "elementor-views/controls/choose": 76,
        "elementor-views/controls/color": 77,
        "elementor-views/controls/dimensions": 78,
        "elementor-views/controls/font": 79,
        "elementor-views/controls/gallery": 80,
        "elementor-views/controls/icon": 81,
        "elementor-views/controls/image-dimensions": 82,
        "elementor-views/controls/media": 83,
        "elementor-views/controls/repeater": 85,
        "elementor-views/controls/section": 86,
        "elementor-views/controls/select-sort": 87,
        "elementor-views/controls/select2": 88,
        "elementor-views/controls/slider": 89,
        "elementor-views/controls/structure": 90,
        "elementor-views/controls/url": 91,
        "elementor-views/controls/wp_widget": 92,
        "elementor-views/controls/wysiwyg": 93,
        "elementor-views/sections": 96
    }],
    ...
    29: [function (require, module, exports) {
        ...
        PanelFooterItemView = Marionette.ItemView.extend({
            ...
            onNavigatorClick: function () {
                if (window.elementor && elementor.navigator) {
                    elementor.navigator.toggle();
                }
            },
    ...
    31: [function (require, module, exports) {
        /**
         * Behavior to handle inner Tabs / Tab controls (controls of type "tabs" + "tab")
         * It wires:
         *  - the "tabs" wrapper control (type = 'tabs')
         *  - the "tab" controls (type = 'tab', with 'tabs_wrapper')
         *  - any control that has 'inner_tab' = tab name
         */
        var InnerTabsBehavior = Marionette.Behavior.extend({
            ...
            handleInnerTabs: function (parent) {
                ...
                _.each(tabsWrappers, function (wrapperView) {
                    // Remove default content (we will append tab items into it)
                    wrapperView.$el.find('.elementor-control-content').remove();

                    var tabsWrapperId = wrapperView.model.get('name');

                    // 2) All "tab" controls belonging to this wrapper
                    ...
                    _.each(tabs, function (tabView, index) {
                        ...
                        // 🔹 ICI : on branche le clic pour émettre "control:tab:clicked"
                        tabView.$el
            ...
            // Fired when a tab control view triggers "control:tab:clicked"
    ...
    }, {"./collections/categories": 32, "./collections/elements": 33, "./views/categories": 36, "./views/elements": 39, "./views/languageselector": 40, "./views/search": 41}],
    ...
    }, {"../collections/elements": 33, "./element": 38}],
    ...
    }, {"elementor-panel/pages/menu/views/item": 43}],
    ...
    }, {"elementor-panel/pages/schemes/base": 44, "elementor-panel/pages/schemes/items/color": 48}],
    ...
    }, {"elementor-panel/pages/schemes/items/base": 47}],
    ...
    }, {"elementor-panel/pages/schemes/base": 44, "elementor-panel/pages/schemes/items/typography": 49}],
    51: [function (require, module, exports) {
        ...
        "elementor-layouts/edit-mode": 28,
        "elementor-layouts/panel/footer": 29,
        "elementor-layouts/panel/header": 30,
        "elementor-panel/pages/editor": 31,
        "elementor-panel/pages/elements/elements": 34,
        "elementor-panel/pages/menu/menu": 42,
        "elementor-panel/pages/schemes/colors": 45,
        "elementor-panel/pages/schemes/disabled": 46,
        "elementor-panel/pages/schemes/typography": 50
    }],
    52: [function (require, module, exports) {
        ...
        BaseSettingsModel = Backbone.Model.extend({
            ...
            toJSON: function (options) {
                ...
                // First, normalize nested models/collections
                ...
                // Then, remove empty values or values equal to defaults, and recursively prune empty structures
                var cleanValue = function (value) {
                    // Preserve numeric 0 and boolean false – they may be meaningful
                    if (value === '' || value === null || typeof value === 'undefined') {
                        return undefined;
                    }

                    // Arrays: clean each item and drop if all items are pruned
                    if (_.isArray(value)) {
                        var newArr = [];
                    ...
                    // Plain objects: clean each property recursively
                    if (_.isObject(value)) {
                        var newObj = {};

                        _.each(value, function (subValue, subKey) {
                            var cleanedSub = cleanValue(subValue);

                            if (typeof cleanedSub !== 'undefined') {
                                newObj[subKey] = cleanedSub;
                            }
                        });

                        // Heuristics for common Elementor structures:
                        // 1) Dimension-like controls: only "unit" left (e.g. { unit: "px" } with all sides empty) => drop
                        if (newObj.unit && Object.keys(newObj).length === 1) {
                            return undefined;
                        }

                        // 2) Media-like controls: empty url/id/size/etc => drop when url is empty and nothing else left
                        if (Object.prototype.hasOwnProperty.call(newObj, 'url') && newObj.url === '' && Object.keys(newObj).length === 1) {
                            return undefined;
                        }

                        // If after cleaning, nothing left, drop object
                        if (_.isEmpty(newObj)) {
                            return undefined;
                        }
                    ...
                    // Any other primitive (strings non-empty, numbers, booleans, etc.) – keep as is
                    return value;
                };

                var cleanedData = {};

                _.each(_.clone(data), function (value, key) {
                    // If the control definition explicitly asks to save empty values,
                    // bypass the default/cleaning logic and keep the raw value.
                    var control = self.getControl ? self.getControl(key) : null;

                    if (control && control.save_empty_value) {
                    ...
                    var hasDefault = self.defaults && Object.prototype.hasOwnProperty.call(self.defaults, key),
                        defaultValue = hasDefault ? self.defaults[key] : undefined;

                    // If a default exists and the value is strictly equal (deep equal for objects), drop it entirely
                    if (hasDefault && _.isEqual(value, defaultValue)) {
                        return;
                    }
    ...
    }, {"elementor-models/base-settings": 52}],
    54: [function (require, module, exports) {
        ...
        ElementModel = Backbone.Model.extend({
            ...
            renderRemoteServer: function () {
                ...
                var data = this.toJSON({cleanEditSettings: true});
            ...
            toJSON: function (options) {
                ...
                // Normalize nested models/collections first
                _.each(data, function (attribute, key) {
                    if (attribute && attribute.toJSON) {
                        data[key] = attribute.toJSON(options);
                    }
                ...
                if (data.defaultEditSettings) {
                    if (_.isArray(data.defaultEditSettings) && !data.defaultEditSettings.length) {
                        delete data.defaultEditSettings;
                    } else if (_.isObject(data.defaultEditSettings) && _.isEmpty(data.defaultEditSettings)) {
                        delete data.defaultEditSettings;
                    }
                }

                // Remove empty editSettings globally (they are not needed in the stored/rendered JSON)
                if (data.editSettings && _.isObject(data.editSettings) && _.isEmpty(data.editSettings)) {
                    delete data.editSettings;
                }

                if (data.elements && _.isArray(data.elements) && !data.elements.length) {
    ...
    }, {"elementor-models/base-settings": 52, "elementor-models/column-settings": 53, "elementor-models/row-settings": 55, "elementor-models/section-settings": 56, "elementor-models/widget-settings": 57}],
 ...
 */
	...
	*/
    ...
    }, {"elementor-models/base-settings": 52, "elementor-utils/stylesheet": 66}],
    68: [function (require, module, exports) {
        ...
        "elementor-behaviors/duplicate": 1,
        "elementor-behaviors/elements-relation": 2,
        "elementor-behaviors/handle-duplicate": 3,
        "elementor-behaviors/handle-edit-mode": 4,
        "elementor-behaviors/handle-editor": 5,
        "elementor-behaviors/resizable": 6,
        "elementor-behaviors/sortable": 7,
        "elementor-views/base-element": 67,
        "elementor-views/element-empty": 94,
        "elementor-views/section": 95,
        "elementor-views/widget": 97
    }],
    ...
    }, {"elementor-views/controls/base-multiple": 72}],
        ...
        ControlBoxShadowItemView = ControlMultipleBaseItemView.extend({
            ...
            initColors: function () {
                ...
                this.ui.colors.wpColorPicker({
                    ...
                    palettes: elementorFrontendConfig.iqitElementorColorPalette,
                    width: 251
                });
            },
    ...
    }, {"elementor-views/controls/base-units": 73}],
    ...
    }, {"elementor-views/controls/base": 74, "elementor-views/controls/repeater-row": 84}],
...
// TODO: This control is unused
    ...
    }, {"elementor-behaviors/duplicate": 1, "elementor-behaviors/elements-relation": 2, "elementor-behaviors/handle-duplicate": 3, "elementor-behaviors/handle-edit-mode": 4, "elementor-behaviors/handle-editor": 5, "elementor-behaviors/sortable": 7, "elementor-views/base-element": 67, "elementor-views/column": 68}],
    ...
    }, {"elementor-behaviors/duplicate": 1, "elementor-behaviors/elements-relation": 2, "elementor-behaviors/handle-duplicate": 3, "elementor-behaviors/sortable": 7, "elementor-views/section": 95}],
    ...
    }, {"elementor-behaviors/handle-edit-mode": 4, "elementor-behaviors/handle-editor": 5, "elementor-views/base-element": 67}]
}, {}, [61, 62, 27])
