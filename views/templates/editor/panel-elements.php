...
<script type="text/template" id="tmpl-elementor-panel-element-languageselector">
		<?php echo Translater::get()->l('Editing:', 'elementor'); ?>
			<select>
			...
			<div  title="<?php echo Translater::get()->l('Import from  other language', 'elementor'); ?>" id="elementor-panel-elements-language-import">
				...
				<div id="elementor-panel-elements-language-import-list">
					<?php echo Translater::get()->l('Import content from  other language', 'elementor'); ?>
					<ul>
					<# _.each( elementor.config.languages, function( language ) { #>
...
<script type="text/template" id="tmpl-elementor-panel-element-search">
	<input id="elementor-panel-elements-search-input" placeholder="<?php echo Translater::get()->l('Search Widget...', 'elementor'); ?>" />
