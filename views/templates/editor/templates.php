...
<script type="text/template" id="tmpl-elementor-template-library-header">
	...
	<div id="elementor-template-library-header-items-area">
		<div id="elementor-template-library-header-close-modal" class="elementor-template-library-header-item" title="<?php echo Translater::get()->l('Close', 'elementor'); ?>">
...
<script type="text/template" id="tmpl-elementor-template-library-header-logo">
	<i class="eicon-elementor-square"></i><span><?php echo Translater::get()->l('Library', 'elementor'); ?></span>
</script>

<script type="text/template" id="tmpl-elementor-template-library-header-save">
	<i class="eicon-save" title="<?php echo Translater::get()->l('Save Template', 'elementor'); ?>"></i>
</script>

<script type="text/template" id="tmpl-elementor-template-library-header-load">
	<i class="icon-upload" title="<?php echo Translater::get()->l('Load Template', 'elementor'); ?>"></i>
</script>

<script type="text/template" id="tmpl-elementor-template-library-header-menu">
	<div id="elementor-template-library-menu-my-templates" class="elementor-template-library-menu-item" data-template-source="local"><?php echo Translater::get()->l('Templates list', 'elementor'); ?></div>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-header-back">
	<i class="eicon-"></i><span><?php echo Translater::get()->l('Back To library', 'elementor'); ?></span>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-templates">
	...
	<div id="elementor-template-library-footer-banner">
		...
		<div class="elementor-excerpt"><?php echo Translater::get()->l('Stay tuned! More awesome templates coming real soon.', 'elementor'); ?></div>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-template-local">
	...
	<div class="elementor-template-library-template-controls">
		...
		<div class="elementor-template-library-template-export">
			<a href="{{ export_link }}">
				<i class="fa fa-sign-out"></i><span class="elementor-template-library-template-control-title"><?php echo Translater::get()->l('Export', 'elementor'); ?></span>
			</a>
		</div>
		<div class="elementor-template-library-template-delete">
			<i class="fa fa-trash-o"></i><span class="elementor-template-library-template-control-title"><?php echo Translater::get()->l('Delete', 'elementor'); ?></span>
		</div>
		<div class="elementor-template-library-template-preview">
			<i class="eicon-zoom-in"></i><span class="elementor-template-library-template-control-title"><?php echo Translater::get()->l('Preview', 'elementor'); ?></span>
		</div>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-save-template">
	...
	<div class="elementor-template-library-blank-footer">
		<?php echo Translater::get()->l('What is Library?', 'elementor'); ?>
		<a class="elementor-template-library-blank-footer-link" href="https://go.elementor.com/docs-library/" target="_blank"><?php echo Translater::get()->l('Read our tutorial on using Library templates.', 'elementor'); ?></a>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-load-template">
	...
	<div class="elementor-template-library-blank-excerpt"><?php echo Translater::get()->l('Import your .json design file from your local pc', 'elementor'); ?></div>
	<form id="elementor-template-library-load-template-form">
		...
		<button id="elementor-template-library-load-template-submit" class="elementor-button elementor-button-success">
			...
			<?php echo Translater::get()->l('load', 'elementor'); ?>
		</button>
	</form>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-templates-empty">
	...
	<div class="elementor-template-library-blank-title"><?php echo Translater::get()->l('Haven\'t Saved Templates Yet?', 'elementor'); ?></div>
	<div class="elementor-template-library-blank-excerpt"><?php echo Translater::get()->l('This is where your templates should be. Design it. Save it. Reuse it.', 'elementor'); ?></div>
	<div class="elementor-template-library-blank-footer">
		<?php echo Translater::get()->l('What is Library?', 'elementor'); ?>
		<a class="elementor-template-library-blank-footer-link" href="https://go.elementor.com/docs-library/" target="_blank"><?php echo Translater::get()->l('Read our tutorial on using Library templates.', 'elementor'); ?></a>
	</div>
